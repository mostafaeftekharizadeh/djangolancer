...
class UserTestCase(TestCase):
    ...
    def test_login(self):
        client = APIClient()
        data = {"mobile": "988121000001", "password": "Test@123"}
    ...
    def test_user_delete(self):
        client = APIClient()
        client.login(username="988121000004", password="Test@123")
        user = User.objects.get(mobile="988121000004")
        response = client.delete("/api/v1/user/user/{}/".format(user.id))        
        assert response.status_code == 200 
        assert User.objects.get(mobile="988121000004").is_active == False
