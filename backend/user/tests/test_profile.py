...
from user.profile_models import Profile, Skill
...
#        user = user_model.objects.filter(username="testuser3")
#        print("-------------------------------------")
#        print(user)
#        print("-------------------------------------")
#        client = APIClient()
...
#            "test_image.jpg", "file_content", content_type="image/jpg"
#        )
#
#        data = {
